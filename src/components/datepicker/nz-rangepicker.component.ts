  ...
  template: `
    ...
    <ng-template #calendarRangePart let-part="part">
      <div class="ant-calendar-range-part"
            ...
            <span class="ant-calendar-ym-select">
                        <a class="ant-calendar-month-select"
                           ...
                           *ngIf="_mode[part] === 'month'"
                           (click)="_mode[part] = 'month';_showSelectMonth[part] = true;_bindDisabledDateToPart()">
        ...
        <div class="ant-calendar-month-panel" *ngIf="_showSelectMonth[part]">
          <div>
            <div class="ant-calendar-month-panel-header">
              ...
              <a class="ant-calendar-month-panel-year-select" title="{{ 'DateTime.chooseYear' | nzTranslate }}" (click)="_mode[part] = 'decade';_showSelectMonth[part] = false">
                <span class="ant-calendar-month-panel-year-select-content">{{ _showYear[part] }}</span>
        ...
        <div class="ant-calendar-body">
          <nz-calendar
            ...
            (nzClickDay)="_clickDay($event, part)"
            [nzClearTime]="!nzShowTime"
            (nzHoverDay)="_hoverDay($event, part)"
...
export class NzRangePickerComponent implements ControlValueAccessor, OnInit {
  ...
  _value: Date[] = this._defaultRangeValue;
  ...
  _offsetX: number = 0;
  _showSelectMonth: boolean[] = [false, false];
  ...
  _hoverDay(day: DayInterface, part): void {
  ...
  _clickMonth(month: MonthInterface, part: RangePart): void {
    ...
    this._showSelectMonth[part] = false;
    this._bindDisabledDateToPart();
